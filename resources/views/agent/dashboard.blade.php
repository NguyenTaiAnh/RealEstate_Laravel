                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Bất động sản</span>
                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Bất động sản gần đây</span>
                                </div>
                            ...
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Thư gần đây</span>
                                </div>
                                <div class="box-content">
