            ...
            <div class="row">
                <div class="col s12 m8">
                    ...
                    <div>
                        ...
                        <span class="btn btn-small disabled b-r-20">Diện tích: {{ $property->area}} m<sup>2</sup></span>
                    </div>
                </div>
                    ...
                    <div>
                        @if($property->features)
                            <ul class="collection with-header">
                                <li class="collection-header grey lighten-4"><h5 class="m-0">Nội thất</h5></li>
                ...
                <div class="col s12 m4">
                    <div class="clearfix">
                                ...
                                <li class="collection-item p-0">
                                    @if($property->user)
                                        ...
                                        <div class="p-l-10 p-r-10">
                                            ...
                                            <a href="{{ route('agents.show',$property->agent_id) }}" class="profile-link">Hồ sơ</a>
                                        </div>
                                    @endif
                                </li>
                        ...
                        <div>
                            <ul class="collection with-header">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Bất động sản liên quan</h5>
                                </li>
