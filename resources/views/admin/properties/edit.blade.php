        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="tinymce">Miêu tả</label>
                        <textarea name="description" id="tinymce">{{$property->description}}</textarea>
                    </div>

                    <hr>
                    <div class="form-group">
                        <label for="tinymce-nearby">Lân cận</label>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="gallery-box">
                        ...
                        <button type="button" class="btn btn-info btn-lg right" id="galleryuploadbutton">UPLOAD IMAGE</button>
                    </div>
                </div>
            </div>
...
{{--                                <option value="apartment" {{ $property->type=='apartment' ? 'selected' : '' }}>Apartment</option>--}}
                                <option value="datnen" {{ $property->type=='datnen' ? 'selected' : '' }}>Đất nền</option>
                                <option value="canho" {{ $property->type=='canho' ? 'selected' : '' }}>Căn hộ</option>
                                <option value="nhapho" {{ $property->type=='nhapho' ? 'selected' : '' }}>Nhà phố</option>
                                <option value="bietthu" {{ $property->type=='bietthu' ? 'selected' : '' }}>Biệt thự</option>
                                <option value="shophouse" {{ $property->type=='shophouse' ? 'selected' : '' }}>Shop house</option>
                            </select>
                        </div>
                    </div>
