    ...
    <div class="row clearfix">
            ...
            <div class="card">
                ...
                <div class="header">
                    <h2>
                        {{$property->title}}
                        <br>
                        <small>Đăng bởi <strong>{{$property->user->name}}</strong> vào {{$property->created_at->diffForHumans()}}</small>
                    </h2>
                </div>
                ...
                <div class="header">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <strong>Giá : </strong>
                            <span class="right"> {{number_format($property->price)}}vnđ</span>
                        </li>
                        <li class="list-group-item">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <strong class="label bg-red">{{$property->type}}</strong> cho <strong class="label bg-blue">{{$property->purpose}}</strong>
                </div>
            </div>
            <div class="card">
